...
public class Vaccinare implements Comparable<Vaccinare> {
    ...
    @Override
    public int compareTo(Vaccinare vaccinare) {
        return Long.compare(this.totalVaccinations, vaccinare.totalVaccinations);
    }
